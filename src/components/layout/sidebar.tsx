...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-50 h-screen w-64 bg-gray-900 text-gray-100 transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:h-screen flex flex-col',
          {
      ...
      >
        <div className="flex flex-col h-full">
          {/* App Title */}
          <div className={cn('flex items-center h-16 px-6 flex-shrink-0', roleColor)}>
